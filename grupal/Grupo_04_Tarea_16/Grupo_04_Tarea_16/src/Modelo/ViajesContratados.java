...
public class ViajesContratados {
    ...
    private Turistas ElementoTurista;
    private int Sucursales_CodigoSucursal;
    private Sucursales ElementoSucursal;
    private int Estancias_CodigoEstancia;
    private Estancias ElementoEstancia;
    ...
    public Turistas getElementoTurista() {
        return ElementoTurista;
    }

    public void setElementoTurista(Turistas ElementoTurista) {
        this.ElementoTurista = ElementoTurista;
    }

    public Sucursales getElementoSucursal() {
        return ElementoSucursal;
    }

    public void setElementoSucursal(Sucursales ElementoSucursal) {
        this.ElementoSucursal = ElementoSucursal;
    }

    public Estancias getElementoEstancia() {
        return ElementoEstancia;
    }

    public void setElementoEstancia(Estancias ElementoEstancia) {
        this.ElementoEstancia = ElementoEstancia;
    }
