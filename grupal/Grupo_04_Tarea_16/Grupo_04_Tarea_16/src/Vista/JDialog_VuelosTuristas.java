...
public class JDialog_VuelosTuristas extends javax.swing.JDialog {
    ...
    private void btn_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RegistrarActionPerformed
        try {
            ...
            DAO_VuelosTuristas.Insertar(nuevo); 
    ...
    private void btn_EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EditarActionPerformed
        ...
        try {
             int numero = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el numero del vuelo a editar"));
              ...
              int nuemro = Integer.parseInt(cbo_numVuelo.getSelectedItem().toString());
              int codigoViaje = Integer.parseInt(cbo_codviaje.getSelectedItem().toString());
                
              VuelosTurista vuelo1 = new VuelosTurista(numero, clase, nuemro, codigoViaje);
                
                
                DAO_VuelosTuristas.Actualizar(vuelo1);
