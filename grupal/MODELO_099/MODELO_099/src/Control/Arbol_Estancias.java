...
public class Arbol_Estancias {
    ...
    //METODO BUSCAR
    public Nodo_Estancias Buscar(Nodo_Estancias Nodo, int Codigo) {
        if (Nodo == null) {
            return null;
        }
        if (Codigo == Nodo.getElemento().getCodigoEstancia()) {
            return Nodo;
        } else if (Codigo < Nodo.getElemento().getCodigoEstancia()) {
    ...
    /*  Metodo equi: 
        |Revisa si el árbol ha quedado desbalanceado.
    
    	Si hay desbalance, 
        aplica Reestructurar 
