...
public class JFrame_principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hoteles.add(jmu_Hoteles);

        jmnu_Sucursales.setText("Sucursales");
        hoteles.add(jmnu_Sucursales);

        jmnu_Turistas.setText("Turistas");
        hoteles.add(jmnu_Turistas);

        jmnu_Vuelos.setText("Vuelos");
        hoteles.add(jmnu_Vuelos);
        ...
        jMenu2.add(jmnu_ViajesContratados);

        jmnu_VuelosTurista.setText("Vuelo Turista");
        jMenu2.add(jmnu_VuelosTurista);
