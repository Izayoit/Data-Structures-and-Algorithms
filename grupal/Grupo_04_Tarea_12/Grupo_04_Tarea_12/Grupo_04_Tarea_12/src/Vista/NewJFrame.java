    ...
    private void JList_conexionesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JList_conexionesMouseClicked
        ...
        if (pos != -1) {
            ...
            if (enlace != null) {
                ...
                JOptionPane.showMessageDialog(this, "falta elementos por agregar");
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (text != null) {
            ...
            switch (numero) {
                case 1:
                    if (buscado != null) {
                        ...
                        if (mascorto != null) {
                            ...
                            String medio = mascorto.getTipo();
                            int tiempo = mascorto.getTiempo();
                            double costo = mascorto.getCosto_Economico();
                            modListaConexion2.addElement("tiempo: " + tiempo + " - " + "costo: " + costo + " - " + "transporte: " + medio + "-" + "enlace: " + Nombrecorto);
                ...
                case 2:
                    if (buscado != null) {
                        ...
                        if (mascorto != null) {
                            ...
                            double costo = mascorto.getCosto_Economico();
                            modListaConexion2.addElement("tiempo: " + tiempo + " - " + "costo: " + costo + " - " + "transporte: " + medio + "-" + "enlace: " + Nombrecorto);
                            JOptionPane.showMessageDialog(this, "costo mas corto encontrado");
                ...
                case 3:
                    if (buscado != null) {
                        Enlace mascorto = buscado.obtenerConexionMasCortaTiempoCosto();
                        ...
                        if (mascorto != null) {
                            ...
                            double costo = mascorto.getCosto_Economico();
                            modListaConexion2.addElement("tiempo: " + tiempo + " - " + "costo: " + costo + " - " + "transporte: " + medio + "-" + "enlace: " + Nombrecorto);
                            JOptionPane.showMessageDialog(this, "Tiempo y costo mas corto encontrado");
