...
public class JFrame_Principal extends javax.swing.JFrame {
    ...
    private String NombreArchivo = "lista_datos.txt";
    ...
    public void Llenar_Tabla(){
        DefaultTableModel modTabla = 
            new DefaultTableModel(new String[]{"Dato"}, 0);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txt_dato, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btn_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RegistrarActionPerformed
        ...
        //lista.add(dato);        
        GestorArchivos.Guardar(NombreArchivo, dato);
