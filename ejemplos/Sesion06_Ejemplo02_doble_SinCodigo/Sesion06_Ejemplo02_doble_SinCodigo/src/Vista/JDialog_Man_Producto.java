...
private Control_Archivos objControl_Archivos = new Control_Archivos();

    private Lista_Doble obj_Lista = new Lista_Doble();
  ...
  int codigo = Integer.parseInt(txt_Codigo.getText());
     ...
     switch (modo) {
            case 1:
               dato1 = new Producto(codigo, descripcion, stock);
                obj_Lista.Agregar(dato1);
                actual= obj_Lista.getFin();
                break;
            case 2:
                dato1 =actual.getElemento();
                dato1.setCodigo(codigo);
                dato1.setDescripcion(descripcion);
                dato1.setStock(stock);
 ...
 if(actual!=null){
   ...
   modo=2;
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        ...
        actual=obj_Lista.getFin()==null?null:actual.getSiguiente();
...
//}
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
      objControl_Archivos.Abrir_Archivo(obj_Lista);
      obj_Lista.Listar(tbl_Datos);
    }//GEN-LAST:event_formWindowOpened

    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        objControl_Archivos.Guardar_Archivo(obj_Lista);
