...
public class JDialog_Curso extends javax.swing.JDialog {

    private int Tipo_Ope = 0;
    private Curso Elemento;
    
    public JDialog_Curso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void Actualizar_Tabla(){
        CursoDAO.ConsultarTodos(tbl_datos);
    }
    ...
    private void btn_EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EditarActionPerformed
        ...
        if(fila != -1){
            int CodCurso = Integer.parseInt(
                    tbl_datos.getValueAt(fila, 0).toString()
                );
            String Nombre = tbl_datos.getValueAt(fila, 1).toString();
            Elemento = new Curso();
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        ...
        if(fila != -1){
            int rpta = JOptionPane.showConfirmDialog(this, 
               "¿Desea eliminar el registro?","Proceso de Eliminación",JOptionPane.YES_NO_OPTION);
            if(rpta == JOptionPane.YES_OPTION){
                int CodCurso = Integer.parseInt(tbl_datos.getValueAt(fila, 0).toString());
                Elemento = new Curso();
                Elemento.setCodCurso(CodCurso);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_Curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialog_Curso dialog = new JDialog_Curso(new javax.swing.JFrame(), true);
