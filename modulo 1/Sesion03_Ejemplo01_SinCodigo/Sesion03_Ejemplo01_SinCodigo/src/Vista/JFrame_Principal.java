...
public class JFrame_Principal extends javax.swing.JFrame {
    ...
    private void btn_InsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_InsertarActionPerformed
        ...
        obj_arreglo_notas.ordenar_burbuja01();
        obj_arreglo_notas.Listar(modLista);
    ...
    private void btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarActionPerformed
        /*
        String valor = JOptionPane.showInputDialog("¿Qué número esta buscando?");
        if(valor != null){
            double dato = Double.parseDouble(valor);
            int pos = obj_arreglo_notas.Buscar(dato);
            if(pos != -1){
                JOptionPane.showMessageDialog(this, "El número " + dato + " se encuentra en el índice " + pos);
            }else{
                JOptionPane.showMessageDialog(this, "El número " + dato + " ¡No existe!");
            }    
        }
        */
        try {
            double dato = Double.parseDouble(JOptionPane.showInputDialog("¿Qué número esta buscando?"));
            int pos = obj_arreglo_notas.Buscar(dato);
            if(pos != -1){
                JOptionPane.showMessageDialog(this, "El número " + dato + " se encuentra en el índice " + pos);
            }else{
