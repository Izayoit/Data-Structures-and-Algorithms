...
public class JFrame_Principal extends javax.swing.JFrame {
    Arreglo_Notas objarreglonotas = new Arreglo_Notas();
    

    public JFrame_Principal() {
        initComponents();
        objarreglonotas.listar(lst_datos);
    ...
    int dato = Integer.parseInt(txt_nota.getText());  
    objarreglonotas.insertar(dato); 
    lbl_desaprobados.setText(objarreglonotas.contar_desaprovados()+"");
    objarreglonotas.listar(lst_datos);
