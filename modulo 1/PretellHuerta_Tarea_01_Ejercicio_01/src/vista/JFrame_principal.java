...
Arreglo_Empleado objArregloEmpleado = new Arreglo_Empleado();

    
    public JFrame_principal() {
        initComponents();
        objArregloEmpleado.listar(tbl_table);
    }
    ...
    Empleado registro = new Empleado(nombre, edad);
    objArregloEmpleado.Registrar(registro);
    objArregloEmpleado.listar(tbl_table);
